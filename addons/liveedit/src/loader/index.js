...
const ADD_DECORATOR_STATEMENT = '.addDecorator(withLiveEdit(__STORY__, __ADDS_MAP__))';
...
function transform(source) {
  ...
  return `
  export var withStorySource = require('@storybook/addon-liveedit').withLiveEdit;
